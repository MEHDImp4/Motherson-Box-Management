...
**Mode**: mvp
**Depends on**: Phase 1
**Requirements**: BOX-01, BOX-02, BOX-03, BOX-04, BOX-07, BOX-08, HOME-01, HOME-02, HOME-03, HOME-04
**Success Criteria** (what must be TRUE):
...
**Mode**: mvp
**Depends on**: Phase 2
**Requirements**: SCAN-01, SCAN-02, SCAN-03, SCAN-04, SCAN-05, SCAN-06, SIM-01
**Success Criteria** (what must be TRUE):
...
|-------|----------------|--------|-----------|
| 1. Database & Auth Setup | 0/1 | Not started | - |
| 2. Box Lifecycle & Home Lookup | 0/1 | Not started | - |

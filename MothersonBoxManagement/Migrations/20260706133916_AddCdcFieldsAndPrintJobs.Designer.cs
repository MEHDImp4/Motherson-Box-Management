...
namespace MothersonBoxManagement.Migrations
{
    ...
    [Migration("20260706133916_AddCdcFieldsAndPrintJobs")]
    partial class AddCdcFieldsAndPrintJobs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MothersonBoxManagement.Entities.Box", b =>
                {
                    ...
                    b.Property<string>("LastPrintStatus")
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("MothersonBoxManagement.Entities.BoxPackage", b =>
                {
                    ...
                    b.Property<string>("AssociationResult")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("BoxScanValue")
                        .HasColumnType("nvarchar(max)");
